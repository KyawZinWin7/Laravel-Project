...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('backend/icon/icofont/icofont.min.css')}}">
        <!-- Boxicon CSS -->'
    <link rel="stylesheet" type="text/css" href="{{asset('backend/icon/boxicons-master/css/boxicons.min.css')}}">
  ...
  <body class="app sidebar-mini">
      ...
      <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user fa-lg"></i></a>
          <ul class="dropdown-menu settings-menu dropdown-menu-right">
            ...
            <li><a class="dropdown-item" href="{{route('signout')}}"><i class="fa fa-sign-out fa-lg"></i> Logout</a></li>
          </ul>
        </li>
      </ul>
    </header>
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{{ Auth::user()->teacher->profile}}" width="50px" height="50px" alt="User Image">
        <div>
